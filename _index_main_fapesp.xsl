                        ...
                        <xsl:element name="quote">
                            ...
                            <xsl:for-each select="//q[@id = $qRef]">
                                ...
                                <xsl:element name="content">
                                    ...
                                    <xsl:choose>
                                        <xsl:when
                                            test="content and content/@size &lt; $maxquotesize">
                                    ...
                                    <xsl:when
                                        ...
                                        <xsl:element name="content">
                                            ...
                                            <xsl:attribute name="dataSourceID">
                                                <xsl:value-of
                                                  select="//dataSource[@id = $parentDocID]/@id"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="dataSourceMIME">
                                                <xsl:value-of
                                                  select="//dataSource[@id = $parentDocID]/@mime"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="docmimetype">
                                                <!-- PD can also be a memo!!! -->
                                                <xsl:choose>
                                                  <xsl:when
                                                  test="contains(ancestor::primDoc/@loc, 'me_')"
                                                  >text/rtf </xsl:when>
                                                  <xsl:otherwise>
                                                  <xsl:value-of
                                                  select="//dataSource[@id = $parentDocID]/@mime"/>
                                        ...
                                        <xsl:element name="content">
                                            ...
                                            <xsl:attribute name="docmimetype">
                                                ...
                                                <xsl:choose>
                                                  ...
                                                  >text/rtf </xsl:when>
                                                  <xsl:when
                                                  test="contains(ancestor::primDoc/@mime, 'indirect')"
                                                  > text/rtf </xsl:when>
                                                  <xsl:otherwise>
                                                  <xsl:value-of
                                                  select="//dataSource[@id = $parentDocID]/@mime"/>
                ...
                <xsl:for-each select="quotations/q">
                    ...
                    <xsl:for-each select="//codings/iLink[@qRef = $qRef]">
                        ...
                        <xsl:element name="code">
                            ...
                            <xsl:choose>
                                <xsl:when
                                    test="//q[@id = $qRef]/content and number(//q[@id = $qRef]/content/@size) &lt; $maxquotesize">
                                    <xsl:attribute name="content">available</xsl:attribute>
        ...
        <xsl:for-each select="//primDocFamilies/primDocFamily">
            ...
            <xsl:element name="PDFamily">
                ...
                <xsl:for-each select="item">
                    ...
                    <xsl:for-each select="$pdsWithCodes/pd[@id = $pd_ID]">
                        <xsl:copy-of select="."/>
                    </xsl:for-each>
                </xsl:for-each>
            </xsl:element>
